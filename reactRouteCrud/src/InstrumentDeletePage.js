...
export function InstrumentDeletePage(props) {
	...
	const [instrument, deleteInstrument] = useState([]);
...
return (
    <div className="p-5 text-center content bg-whitesmoke">
            ...
            >
			<div>
				<NavLink to="/"><button type="button" className="btn btn-primary m-1">Vissza</button></NavLink>
				<button type="submit" className="btn btn-success m-1">Küldés</button>
			</div>
			</form>
	</div>
);
